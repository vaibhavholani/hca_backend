...
class MemoEntry(Entry):
    ...
    def __init__(self, memo_number: int, supplier_id: int, party_id: int, amount: int, mode: str, register_date: Union[str, datetime], selected_bills: List[int]=[], payment: List[Dict[Union[int, str]]]=[], selected_part: List[Dict[int]]=[], gr_amount: int=0, deduction: int=0, table_name: str='memo_entry', *args, **kwargs) -> None:
    ...
    def from_dict(cls, data: Dict, parse_memo_bills: bool=False) -> MemoEntry:
        ...
        int_attributes = ['memo_number', 'supplier_id', 'party_id', 'amount', 'selected_bills', 'gr_amount', 'deduction']
