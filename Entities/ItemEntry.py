...
class ItemEntry(Entry):
    ...
    def __init__(self, register_entry_id: int, item_id: int, quantity: int, rate: int, table_name='item_entry', *args, **kwargs) -> None:
        """Initializes an ItemEntry with register entry ID, item ID, quantity, and rate."""
    ...
    def get_id(self) -> int:
        ...
        if super_id is not None:
            return super_id
        return get_item_entry_id(self.register_entry_id, self.item_id)
