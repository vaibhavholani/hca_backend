...
@app.route('/hca/add/register_entry/<int:bill>/<int:amount>/<string:supplier>/<string:party>/<string:date>', methods=['GET'])
...
@app.route('/hca/create_report', methods=['POST'])
def create_report():
